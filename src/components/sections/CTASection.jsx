export default function CTASection() {
  return (
    <>
      {/* 5️⃣ CTA Final */}
      <section className="py-24 bg-white dark:bg-[#0D0D14] transition-colors duration-300">
        <div className="container mx-auto px-6">
          <div className="bg-[#7B2FFF] rounded-3xl p-8 md:p-16 text-center text-white shadow-2xl shadow-[#7B2FFF]/30 dark:shadow-[#7B2FFF]/20 relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-3xl mx-auto">
              ...
              <p className="text-white/80 text-lg mb-10">
                ...
                optimizar tu presencia digital hoy mismo.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <a
                  ...
                  className="flex items-center justify-center gap-2 bg-[#25D366] hover:bg-[#1ebe5d] text-white px-10 py-4 rounded-full font-bold text-lg transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-1"
                >
                  <svg
